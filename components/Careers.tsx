  ...
  return (
    <section className="mt-20 flex flex-col gap-10 items-center">
      ...
      <div className="text-2xl font-extralight">
        Every Innosoft employee inspires innovation in our client’s digital
        transformation.
      </div>
      <div className="w-3/4 mb-10 flex flex-row overflow-hidden rounded-xl">
        <div className="w-1/2 bg-[#265B9D]">
          <p className="text-justify text-white font-extralight text-lg p-5">
            ...
            professional skills while building a career with unlimited
            potential. We offer meaningful, impactful assignments that includes
            team building, career development opportunities in healthcare IT,
            and more!
          </p>
          <div className="p-5">
