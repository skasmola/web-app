  ...
  return (
    <footer className="mt-auto">
      ...
      <div
        ...
        style={{ background: "linear-gradient(90deg, #011732 , #4286DA)" }}
      >
        <div className="mx-auto pl-4 pr-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="col-span-1">
              <h3 className="font-semibold text-4xl text-center text-balance">
                Inspiring Innovation in Digital Transformation
              </h3>
            </div>
          </div>
      ...
      <div className="flex justify-center flex-row bg-black items-center gap-20">
        ...
        <Link href="#" className="text-white py-4 font-thin">
          Bussiness Ethics and Compliance Policy
        </Link>
      </div>
    </footer>
  );
